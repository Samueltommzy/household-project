...
public class Runner
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Child count: "+ smiths.noOfChildren());
        ...
        smiths.removeAChild("joe");
        smiths.removeAChild(3);
        System.out.println("After removing joe");
        // how to display dog data ??
        smiths.showAllChildren();
        System.out.println("Child count: "+ smiths.noOfChildren());
        System.out.println("All Dogs using showAllDogs()");
        smiths.showAllDogs();
        System.out.println("All dogs using getAllDogs()");
        for(Dog d : smiths.getAllDogs()){
